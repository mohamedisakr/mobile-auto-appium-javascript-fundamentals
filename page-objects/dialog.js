class Dialog {
  ...
  // #region Activity
  get cancelDialogMsgBtn() {
    return $(
      '//android.widget.Button[@content-desc="OK Cancel dialog with a message"]'
    );
  }
  get cancelLongDialogMsgBtn() {
    return $(
      '//android.widget.Button[@content-desc="OK Cancel dialog with a long message"]'
    );
  }
  get cancelUltraLongDialogMsgBtn() {
    return $(
      '//android.widget.Button[@content-desc="OK Cancel dialog with ultra long message"]'
    );
  }
  get dialogModalTitle() {
